                        ...
                        <div class="well">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3>
                                        Personal Portfolio
                                    </h3><a href="http://www.brianemory.com"><img class="img-responsive project-image" src="img/port-portfolio.jpg"></a>
                                </div>
                                <div class="col-md-4">
                                    <h3>
                                        Random Quote Machine
                                    </h3><a href="http://codepen.io/thebrianemory/full/QyzgPg/" target="_blank"><img class="img-responsive project-image" src="img/port-qm.jpg"></a>
                                </div>
                                <div class="col-md-4">
                                    <h3>
                                        Dev Match
                                    </h3><img class="img-responsive project-image" src="img/port-devmatch.png">
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-left about-text">
                            <p>
                                I am a growing web developer with a focus on Ruby on Rails currently in Los Angeles, CA. My wife and I moved out here last year from the blistering desert of Las Vegas. I've always wanted to live in southern California but ultimately it was about keeping the Mrs. happy. Wise man once said, "Happy wife, happy life."</p>
